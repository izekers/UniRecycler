...
import net.zoker.unirecycler.interfaces.IRefreshListBuider;
...
public abstract class SingleRefreshListFragment<Data, VH extends RecyclerView.ViewHolder> extends RecyclerFragment<Data,VH> implements IRefreshListBuider<Data, VH> {
